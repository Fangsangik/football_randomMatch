...
public class VendorStadiumServiceImpl implements VendorStadiumService {
    ...
    @Transactional
    @Override
    public StadiumResponseDto createStadium(StadiumRequestDto requestDto, Vendor vendor) {
    ...
    @Transactional
    @Override
    public StadiumUpdateDto updateStadium(StadiumUpdateDto requestDto, Vendor vendor) {
        validateVendorRole(vendor);
    ...
    @Override
    public FindMyStadiumResponseDto findMyStadiums(Long stadiumId, Vendor vendor) {
        validateVendorRole(vendor);
    ...
    @Override
    public List<StadiumResponseDto> getMyStadiums(Vendor vendor) {
        validateVendorRole(vendor);
    ...
    @Transactional
    @Override
    public void deleteStadium(Long id, Vendor vendor) {
        validateVendorRole(vendor);
